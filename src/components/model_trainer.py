...
class ModelTrainer:
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            ...
            train_arr = self.utils.load_numpy_array_data(file_path=self.data_transformation_artifact.transformed_train_file_path)
            test_arr = self.utils.load_numpy_array_data(file_path=self.data_transformation_artifact.transformed_test_file_path)
            ...
            self.utils.save_object(self.model_trainer_config.trained_model_file_path, my_model)
